...
config :w_core, WCoreWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RGML7KGCM1YVsz4H0Uu2IH2G6cNzRJTJDWu/0mbiRXCfPgg4oJB/Z0ANjOJlJw/z",
  watchers: [
...
config :w_core, WCoreWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/w_core_web/router\.ex$"E,
      ~r"lib/w_core_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
